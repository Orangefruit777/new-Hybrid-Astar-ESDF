...
void initializeObstacleCloud() {
  ...
  // // 添加边界障碍物
  // addObstacleRectangle(obstacle_cloud_, -10.0, 10.0, -10, -9.5, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, -10, 10.0, 9.5, 10.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, -10.0, -9.5, -9.5, 9.5, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, 9.5, 10.0, -9.5, 9.5, obstacle_interval);

  // addObstacleRectangle(obstacle_cloud_, 2.5, 5.5, 2.5, 6.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, -2.5, 0.0, 5.0, 8.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, 5.0, 8.0, -5.0, -3.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, 1.0, 4.0, -8.0, -2.0, obstacle_interval);

  // addObstacleRectangle(obstacle_cloud_, -8.0, -5.5, 0.5, 8.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, 7.0, 9.0, -1.0, 8.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, -4.0, -1.0, -4.0, 2.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, -8.0, -3.0, -8.0, -6.0, obstacle_interval);

  // addObstacleRectangle(obstacle_cloud_, 7.5, 9.0, -8.0, -6.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, -8.0, -6.0, -4.0, -1.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, 2.0, 5.0, 7.0, 8.5, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, 1.0, 5.0, -1.0, 1.0, obstacle_interval);

  {
  // double obstacle_interval = 0.2;

  // addObstacleRectangle(obstacle_cloud_, -20.0, 20.0, -20.0, -19.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, -20.0, 20.0, 19.0, 20.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, -20.0, -19.0, -19.0, 19.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, 19.0, 20.0, -19.0, 19.0, obstacle_interval);

  // addObstacleRectangle(obstacle_cloud_, 5.0, 11.0, 5.0, 12.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, -5.0, 0.0, 10.0, 16.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, 10.0, 16.0, -10.0, -6.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, 2.0, 8.0, -16.0, -4.0, obstacle_interval);

  // addObstacleRectangle(obstacle_cloud_, -16.0, -11.0, 1.0, 16.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, 14.0, 18.0, -2.0, 16.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, -8.0, -2.0, -8.0, 4.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, -16.0, -6.0, -16.0, -12.0, obstacle_interval);

  // addObstacleRectangle(obstacle_cloud_, 15.0, 18.0, -16.0, -12.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, -16.0, -12.0, -8.0, -2.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, 4.0, 10.0, 14.0, 17.0, obstacle_interval);
  // addObstacleRectangle(obstacle_cloud_, 2.0, 10.0, -2.0, 2.0, obstacle_interval);
  }
  // 设置点云属性
